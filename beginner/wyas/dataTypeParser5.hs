...
{- Exercise 5
    ...
    Add a Character constructor to LispVal and add a parser for
    Scheme character literals 
    http://www.schemers.org/Documents/Standards/R5RS/HTML/r5rs-Z-H-2.html)

    Notes:
       The standard says there are two notations:
       ...
       And gives the examples:
           ...
           #\(         left parentheses
           #\          space character
           #\space     character name for space
           #\newline   character name for newline
